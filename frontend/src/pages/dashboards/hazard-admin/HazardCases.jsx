      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-5">
        {[
          ...
          },
          {
            ...
            box: "bg-white border-cyan-100",
            iconBox: "bg-cyan-50",
          },
          {
            label: "In Progress",
            value: stats.inProgress,
            icon: <Loader2 className="h-5 w-5 text-orange-700" />,
            box: "bg-white border-orange-100",
          ...
          <div
            key={card.label}
            className={`flex items-center justify-between rounded-2xl border ${card.box} p-5 shadow-sm`}
          >
            <div>
            ...
            <div className={`flex h-12 w-12 items-center justify-center rounded-xl ${card.iconBox}`}>
              {card.icon}
            </div>
          </div>
        ))}
              ...
              {loading ? (
                ...
                <tr>
                  <td colSpan={9} className="px-5 py-12 text-center">
                    <p className="text-lg font-black text-slate-800">No hazard cases found</p>
                ...
                filteredCases.map((item) => (
                  ...
                  >
                    <td className="px-5 py-4">
                      <p className="font-black text-slate-900">{item.caseId}</p>
                    </td>
                    ...
                    <td className="px-5 py-4">
                      {item.handlingStatus === "RESOLVED" ? (
                        <span className="inline-flex rounded-xl bg-emerald-50 px-3 py-2 text-xs font-bold text-emerald-700 border border-emerald-200">
                          Resolved
                        </span>
                      ) : (
                        <button
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-rose-200 bg-rose-50 text-rose-700 hover:bg-rose-100 transition"
                          title="Delete case"
                        >
          ...
          <div className="w-full max-w-md overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-200 px-6 py-5">
              <div>
                ...
                <h3 className="mt-1 text-xl font-black text-slate-900">Confirm Delete</h3>
              </div>
            ...
            <div className="space-y-5 p-6">
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  disabled={deleting}
                  className="inline-flex items-center gap-2 rounded-xl bg-rose-600 px-5 py-3 text-sm font-bold text-white hover:bg-rose-700 disabled:opacity-60"
                >
                  {deleting ? (
                    <>
          ...
          <div className="w-full max-w-lg overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-200 px-6 py-5">
              <div>
                ...
                <h3 className="mt-1 text-xl font-black text-slate-900">Add Resolution Note</h3>
              </div>
