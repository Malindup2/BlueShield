...
const MENU_ITEMS = [
  ...
  { title: "Zones", path: "/dashboard/illegal-admin/zones", icon: <Layers className="w-5 h-5" />, roles: ["ILLEGAL_ADMIN", "SYSTEM_ADMIN"] },
  ...
  { title: "Zones", path: "/dashboard/hazard-admin/zones", icon: <Layers className="w-5 h-5" />, roles: ["HAZARD_ADMIN", "SYSTEM_ADMIN"] },
...
export default function Sidebar() {
  ...
  // TODO: Replace this with actual context or hook determining the user's role
  // Temporary hardcoded default until integration
  const currentRole = localStorage.getItem("userRole") || "FISHERMAN"; 

  // Filter menu items based on the user's actual role
